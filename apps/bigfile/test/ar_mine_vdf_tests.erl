...
test_vdf_sha() ->
	...
	{ok, Real1, _OutCheckpointSha} = big_vdf_nif:vdf_sha2_nif(Salt1, PrevState, 0, 0, ?ITERATIONS_SHA),
	ExpectedHash = soft_implementation_vdf_sha(Salt1, PrevState, ?ITERATIONS_SHA, 0),
	?assertEqual(ExpectedHash, Real1),

	{ok, RealSha2, OutCheckpointSha2} = big_vdf_nif:vdf_sha2_nif(Salt2, Real1, ?CHECKPOINT_COUNT-1, 0, ?ITERATIONS_SHA),
	{ok, RealSha3, OutCheckpointSha3} = big_vdf_nif:vdf_sha2_nif(Salt1, PrevState, ?CHECKPOINT_COUNT, 0, ?ITERATIONS_SHA),
...
test_vdf_sha_skip_iterations() ->
	...
	{ok, Real1, _OutCheckpointSha} = big_vdf_nif:vdf_sha2_nif(Salt1, PrevState, 0, ?CHECKPOINT_SKIP_COUNT, ?ITERATIONS_SHA),
	ExpectedHash = soft_implementation_vdf_sha(Salt1, PrevState, ?ITERATIONS_SHA, ?CHECKPOINT_SKIP_COUNT),
	?assertEqual(ExpectedHash, Real1),

	{ok, RealSha2, OutCheckpointSha2} = big_vdf_nif:vdf_sha2_nif(SaltJump, Real1, ?CHECKPOINT_COUNT-1, ?CHECKPOINT_SKIP_COUNT, ?ITERATIONS_SHA),
	{ok, RealSha3, OutCheckpointSha3} = big_vdf_nif:vdf_sha2_nif(Salt1, PrevState, ?CHECKPOINT_COUNT, ?CHECKPOINT_SKIP_COUNT, ?ITERATIONS_SHA),
