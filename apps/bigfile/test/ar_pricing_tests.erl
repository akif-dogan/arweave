...
test_auto_redenomination_and_endowment_debt() ->
	...
	{Reward3, _} = ar_test_node:get_tx_price(main, 0, big_wallet:to_address(Pub2)),
	...
	TX11 = ar_test_node:sign_tx(main, Key3, #{ denomination => 1, target => big_wallet:to_address(Pub5),
			quantity => 100 }),
